...
const GithubIcon = forwardRef<GithubIconHandle, GithubIconProps>(
    ({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
        ...
        const handleMouseEnter = useCallback(
            ...
            [bodyControls, onMouseEnter, tailControls, setIsHovered]
        );
        ...
        const handleMouseLeave = useCallback(
            ...
            [bodyControls, tailControls, onMouseLeave, setIsHovered]
        );
        ...
        return (
            ...
            >
                <svg
                    ...
                    style={{ color: isHovered ? '#6e5494' : '#ffffff', transition: 'color 0.3s ease' }}
                >
                    <motion.path
